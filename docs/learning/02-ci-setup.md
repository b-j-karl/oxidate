...
## What I learned
Basic tooling like Cargo, rustfmt, and Clippy comes pre-installed with Rust, which is great. Linting, formatting, and testing tools were all simple `cargo` commands that I could easily add to the CI pipeline.
